...
const secondOfferHistory = {
  insertedAt: '2020-09-29T10:12:58.070996+00:00',
  playerId: '2748779076705',
  currencyId: 1,
  price: '70',
  rnd: '375503914',
  ...
  stateExtra: '',
  seller: '0xF7dF8923eE9De53e5ffC40F51F96df72bAcC0BA4',
  buyer: '0xaC347a9Fa330c6c23136F1460086D436ed55a3f7',
  auctionId: 'fa3944fc76f6d9b8dc9775ba385dbdbef34b19b0f39e2d37fa728d094885b4a4',
  buyerTeamId: '2748779069846',
};
...
test('processStartedOffers works correctly more than 1 offerer', async () => {
  ...
  //now the offer history from second offerer comes
  await processStartedOffers({ offerHistory: secondOfferHistory });
...
test('processStartedOffers works correctly with 1 offerer', async () => {
  ...
  expect(notifyNewHigherOffer).toHaveBeenCalledTimes(0);
});
