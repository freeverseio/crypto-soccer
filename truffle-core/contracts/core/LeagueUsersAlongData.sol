...
contract LeagueUsersAlongData is LeaguesScheduler {
    ...
    function updateUsersAlongDataHash(uint256 id, uint256[] memory teamIds, uint8[] memory tactics, uint256[] memory blocks) public {
        require(_exists(id), "unexistent league");
    ...
    function computeUsersAlongDataHash(uint256[] memory teamIds, uint8[] memory tactics, uint256[] memory blocks) public pure returns (bytes32) {
        bytes32 base;
        return _computeUsersAlongDataHash(base, teamIds, tactics, blocks);
    }

    function _computeUsersAlongDataHash(bytes32 base, uint256[] memory teamIds, uint8[] memory tactics, uint256[] memory blocks) private pure returns (bytes32 usersAlongDataHash) {
