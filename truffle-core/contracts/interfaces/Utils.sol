...
contract Utils is EncodingMatchLog, AssetsView{
    ...
    function fullDecodeSkills(uint256 encodedSkills) public pure returns(
        ...
        uint256 playerId, 
        bool[4] memory aligned1stSubst1stRedCardLastGameOutOfGame1st,
        ...
        aligned1stSubst1stRedCardLastGameOutOfGame1st[0] = getAlignedEndOfFirstHalf(encodedSkills);
        aligned1stSubst1stRedCardLastGameOutOfGame1st[1] = getSubstitutedFirstHalf(encodedSkills);
        aligned1stSubst1stRedCardLastGameOutOfGame1st[2] = getRedCardLastGame(encodedSkills);
        aligned1stSubst1stRedCardLastGameOutOfGame1st[3] = getOutOfGameFirstHalf(encodedSkills);
