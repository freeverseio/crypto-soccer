...
contract('MatchEvents', (accounts) => {
    ...
    it2('play a match with a special playerId that made it fail before fixing a bug', async () => {
        ...
        result = await engine.playHalfMatchWithoutCost(seed, now, [teamStateAll50Half1, teamStateAll50Half1], [tactics0, tactics0], firstHalfLog, matchBools).should.be.fulfilled;
    });
