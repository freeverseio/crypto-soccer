...
contract("Market", accounts => {
  ...
  beforeEach(async () => {
    ...
    await assets.transferBotToAddr(sellerTeamId, sellerAccount.address).should.be.fulfilled;
    await assets.transferBotToAddr(buyerTeamId, buyerAccount.address).should.be.fulfilled;
