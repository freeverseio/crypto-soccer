...
contract('Engine', (accounts) => {
    ...
    it('check that penalties are played in playoff games and excluding redcarded players', async () => {
        ...
        log1 = await encodingLog.encodeMatchLog(
            nGoals = 2, 
            assistersIdx, 
            shootersIdx, 
            shooterForwardPos, 
        ...
        log2 = await engine.playMatch(seedDraw, now, [teamStateAll50Half2, teamStateAll50Half2], [tactics442, tactics1], [log0, log1], [is2nd = true, isHomeStadium,  playoff = true]).should.be.fulfilled;
