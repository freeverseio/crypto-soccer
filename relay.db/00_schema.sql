...
CREATE TABLE trainings (
    ...
    goalkeepers_defence INT NOT NULL CHECK (goalkeepers_defence >= 0),
    goalkeepers_speed INT NOT NULL CHECK (goalkeepers_speed >= 0),
    goalkeepers_pass INT NOT NULL CHECK (goalkeepers_pass >= 0),
    goalkeepers_shoot INT NOT NULL CHECK (goalkeepers_shoot >= 0),
    goalkeepers_endurance INT NOT NULL CHECK (goalkeepers_endurance >= 0),

    defenders_defence INT NOT NULL CHECK (defenders_defence >= 0),
    defenders_speed INT NOT NULL CHECK (defenders_speed >= 0),
    defenders_pass INT NOT NULL CHECK (defenders_pass >= 0),
    defenders_shoot INT NOT NULL CHECK (defenders_shoot >= 0),
    defenders_endurance INT NOT NULL CHECK (defenders_endurance >= 0),

    midfielders_defence INT NOT NULL CHECK (midfielders_defence >= 0),
    midfielders_speed INT NOT NULL CHECK (midfielders_speed >= 0),
    midfielders_pass INT NOT NULL CHECK (midfielders_pass >= 0),
    midfielders_shoot INT NOT NULL CHECK (midfielders_shoot >= 0),
    midfielders_endurance INT NOT NULL CHECK (midfielders_endurance >= 0),

    attackers_defence INT NOT NULL CHECK (attackers_defence >= 0),
    attackers_speed INT NOT NULL CHECK (attackers_speed >= 0),
    attackers_pass INT NOT NULL CHECK (attackers_pass >= 0),
    attackers_shoot INT NOT NULL CHECK (attackers_shoot >= 0),
    attackers_endurance INT NOT NULL CHECK (attackers_endurance >= 0),

    special_player_defence INT NOT NULL CHECK (special_player_defence >= 0),
    special_player_speed INT NOT NULL CHECK (special_player_speed >= 0),
    special_player_pass INT NOT NULL CHECK (special_player_pass >= 0),
    special_player_shoot INT NOT NULL CHECK (special_player_shoot >= 0),
