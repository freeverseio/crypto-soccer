 ...
 */
contract CryptoPlayersDappChain is ERC721DAppToken, ERC721Token, ERC721Receiver {
  ...
  /**
    ...
    */
  constructor(address _gateway) ERC721Token("CryptoPlayersDappChain", "CRC") public {
    gateway = _gateway;
  }
