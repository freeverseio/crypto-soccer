...
const CounterABI = "[{\"constant\":false,\"inputs\":[],\"name\":\"inc\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"i\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"}]"
...
//
// Solidity: function i() constant returns(uint256)
func (_Counter *CounterCaller) I(opts *bind.CallOpts) (*big.Int, error) {
	var (
		ret0 = new(*big.Int)
	)
	out := ret0
	err := _Counter.contract.Call(opts, out, "i")
	return *ret0, err
}
...
//
// Solidity: function i() constant returns(uint256)
func (_Counter *CounterSession) I() (*big.Int, error) {
	return _Counter.Contract.I(&_Counter.CallOpts)
}

// I is a free data retrieval call binding the contract method 0xe5aa3d58.
//
// Solidity: function i() constant returns(uint256)
func (_Counter *CounterCallerSession) I() (*big.Int, error) {
	return _Counter.Contract.I(&_Counter.CallOpts)
}
