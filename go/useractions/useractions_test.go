...
func TestMarshal(t *testing.T) {
	...
	ua.Tactics = append(ua.Tactics, storage.VerseTactic{3, storage.Tactic{TeamID: "ciao"}})
	ua.Trainings = append(ua.Trainings, storage.VerseTraining{5, storage.Training{TeamID: "pippo"}})
	data, err = ua.Marshal()
	if err != nil {
		t.Fatal(err)
	}
	if string(data) != `{"tactics":[{"verse":3,"tactic":{"team_id":"ciao","tactic_id":0,"shirt_0":0,"shirt_1":0,"shirt_2":0,"shirt_3":0,"shirt_4":0,"shirt_5":0,"shirt_6":0,"shirt_7":0,"shirt_8":0,"shirt_9":0,"shirt_10":0,"shirt_11":0,"shirt_12":0,"shirt_13":0,"extra_attack_1":false,"extra_attack_2":false,"extra_attack_3":false,"extra_attack_4":false,"extra_attack_5":false,"extra_attack_6":false,"extra_attack_7":false,"extra_attack_8":false,"extra_attack_9":false,"extra_attack_10":false}}],"trainings":[{"verse":5,"training":{"team_id":"pippo","special_player_shirt":0,"goalkeepers_defence":0,"goalkeepers_speed":0,"goalkeepers_pass":0,"goalkeepers_shoot":0,"goalkeepers_endurance":0,"defenders_defence":0,"defenders_speed":0,"defenders_pass":0,"defenders_shoot":0,"defenders_endurance":0,"midfielders_defence":0,"midfielders_speed":0,"midfielders_pass":0,"midfielders_shoot":0,"midfielders_endurance":0,"attackers_defence":0,"attackers_speed":0,"attackers_pass":0,"attackers_shoot":0,"attackers_endurance":0,"special_player_defence":0,"special_player_speed":0,"special_player_pass":0,"special_player_shoot":0,"special_player_endurance":0}}]}` {
		t.Fatalf("Wrong %v", string(data))
	}
}
...
func TestIpfsPushAndPull(t *testing.T) {
	...
	if cif != "QmNuETdJchencgidaFNtgZwuneHDvNVKq1rekvN3NoZjPx" {
	...
	if cif != "QmUvykKWb88kqBiSgS9G7pmh3Z5X1R5S4AE2bk9g91LunM" {
		t.Fatalf("Wrong cif %v", cif)
	}
