...
func TestMatchEvents(t *testing.T) {
	...
	is2ndHalf := false
	computedEvents, err := matchevents.GenerateMatchEvents(t, seed, matchLog, events, is2ndHalf)
	if err != nil {
	...
	expected := "[1, 0, 1, 1, 10, 2][3, 1, 0, 0, 4, -1][6, 1, 1, 0, 8, 0][9, 0, 0, 0, 4, -1][12, 0, 0, 0, 4, -1][15, 0, 0, 0, 4, -1][18, 0, 0, 0, 4, -1][21, 0, 0, 0, 4, -1][24, 0, 0, 0, 4, -1][27, 0, 0, 0, 4, -1][30, 0, 0, 0, 4, -1][33, 0, 0, 0, 4, -1][15, 3, -1, -1, 3, -1][29, 2, -1, -1, 4, -1]"
	if concat != expected {
