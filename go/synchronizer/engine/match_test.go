...
func TestPlayGame(t *testing.T) {
	...
	for i := 0; i < 25; i++ {
		...
		m.HomeTeam.Players[i].SetPlayerId(*bc.Contracts, new(big.Int).SetUint64(21342314523))
		m.VisitorTeam.Players[i].SetPlayerId(*bc.Contracts, new(big.Int).SetUint64(21342314523))
	}
