...
import (
	...
	engine "github.com/freeverseio/crypto-soccer/go/synchronizer/engine/v1"
...
func TestMatchHash(t *testing.T) {
	t.Parallel()
	m := engine.NewMatch()
	assert.Equal(t, fmt.Sprintf("%x", m.Hash()), "8d2baaffd12dc489ffac89182e7cfb32e054ff77ffb40c1a21a69566f462f1e2")
}
