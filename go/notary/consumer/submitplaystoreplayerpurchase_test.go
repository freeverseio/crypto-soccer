...
func TestSubmitPlayStorePlayerPurchaseEmptyEvent(t *testing.T) {
	...
	assert.Error(t, consumer.SubmitPlayStorePlayerPurchase(service, in), "unexpected end of JSON input")
}
...
func TestSubmitPlayStorePlayerPurchase(t *testing.T) {
	...
	assert.NilError(t, consumer.SubmitPlayStorePlayerPurchase(service, in))
}
