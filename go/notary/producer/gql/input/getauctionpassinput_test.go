...
func TestGetAuctionPassHash(t *testing.T) {
...
func TestGetAuctionPassSignature(t *testing.T) {
...
func TestGetAuctionPassSignature2(t *testing.T) {
	in := input.GetAuctionPassInput{}
...
func TestGetAuctionPassSignerIsOwnerOfTeam(t *testing.T) {
	privateKey, err := crypto.HexToECDSA("3B878F7892FBBFA30C8AED1DF317C19B853685E707C2CF0EE1927DC516060A54")
	assert.NilError(t, err)
	in := input.GetAuctionPassInput{}
	in.TeamId = "4"
