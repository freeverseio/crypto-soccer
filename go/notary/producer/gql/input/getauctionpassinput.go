...
type GetAuctionPassInput struct {
	Signature string
	TeamId    graphql.ID
}

func (b GetAuctionPassInput) Hash() (common.Hash, error) {
...
func (b GetAuctionPassInput) SignerAddress() (common.Address, error) {
	hash, err := b.Hash()
	if err != nil {
...
func (b GetAuctionPassInput) IsSignerOwner(contracts contracts.Contracts) (bool, error) {
