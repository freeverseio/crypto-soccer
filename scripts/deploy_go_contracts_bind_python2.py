...
if __name__ == "__main__":
    ...
    dests = [os.path.join(parentdir,'go','contracts', 'autogenerated'),
             ]
    ...
    deploy_go_contract(os.path.join(truffle_contracts_dir, 'MarketView.json'), 'marketview', dests)
    deploy_go_contract(os.path.join(truffle_contracts_dir, 'Updates.json'), 'updates', dests)
    deploy_go_contract(os.path.join(truffle_contracts_dir, 'UpdatesView.json'), 'updatesview', dests)
    ...
    deploy_go_contract(os.path.join(truffle_contracts_dir, 'Utils.json'), 'utils', dests)
