    ...
    Mutation: {
      ...
      setTactic: async (_, params, context) => {
        ...
        const query = sql.query`INSERT INTO tactics (
                ...
                ${sql.value(params.substitution0Shirt)},
                ${sql.value(params.substitution0Target)},
                ${sql.value(params.substitution0Minute)},
                ${sql.value(params.substitution1Shirt)},
                ${sql.value(params.substitution1Target)},
                ${sql.value(params.substitution1Minute)},
                ${sql.value(params.substitution2Shirt)},
                ${sql.value(params.substitution2Target)},
                ${sql.value(params.substitution2Minute)},
                ...
                substitution_0_shirt=${sql.value(params.substitution0Shirt)},
                substitution_0_target=${sql.value(params.substitution0Target)},
                substitution_0_minute=${sql.value(params.substitution0Minute)},
                substitution_1_shirt=${sql.value(params.substitution1Shirt)},
                substitution_1_target=${sql.value(params.substitution1Target)},
                substitution_1_minute=${sql.value(params.substitution1Minute)},
                substitution_2_shirt=${sql.value(params.substitution2Shirt)},
                substitution_2_target=${sql.value(params.substitution2Target)},
                substitution_2_minute=${sql.value(params.substitution2Minute)},
